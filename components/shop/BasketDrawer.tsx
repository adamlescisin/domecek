...
export default function BasketDrawer({ open, onClose, onCheckout, strings }: BasketDrawerProps) {
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-border">
          <h2 className="font-display text-xl font-semibold text-charcoal">{s.basket_title}</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
              ...
              <p className="font-body text-charcoal/50">{s.basket_empty}</p>
            </div>
          ) : (
